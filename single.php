...
$selectposts->execute();
$post = $selectposts->fetch(pdo::FETCH_ASSOC);


$views = $connection->prepare("INSERT INTO views SET view_post=?");
$views->bindValue(1, $id);
$views->execute();

$counteree = $connection->prepare("SELECT COUNT(*) as total FROM views WHERE view_post=?");
$counteree->bindValue(1, $id);
$counteree->execute();

$counterVIEWS = $counteree->fetch(PDO::FETCH_ASSOC);
$counterVIEWSs = $counterVIEWS['total'];
...
<nav class="navMenu navbar navbar-dark navbar-expand-lg align-items-center bg-primary fixed-top">
    <div class="container flex-row-reverse">
        <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand text-white fw-bold fs-5" href="/index.php"><img
...
<main style="margin-top: 10rem; margin-bottom: 5rem;">
    <div class="post-container w-100 mx-auto">
        <div class="content bg-white">
            ...
            <span class="author"><?PHP echo "تعداد بازدیدها: " . $counterVIEWSs;
                ?></span>
